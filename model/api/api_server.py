...
try:
    ...
    # Get model path - works in both local and Docker
    import os
    MODEL_DIR = os.environ.get('MODEL_DIR', '../models')

    # Load Penetasan model
    model_penetasan = joblib.load(f'{MODEL_DIR}/model_penetasan_maggot.pkl')
    metadata_penetasan = joblib.load(f'{MODEL_DIR}/model_penetasan_metadata.pkl')
    le_media = joblib.load(f'{MODEL_DIR}/label_encoder_media.pkl')
    le_weather = joblib.load(f'{MODEL_DIR}/label_encoder_weather.pkl')
    le_season = joblib.load(f'{MODEL_DIR}/label_encoder_season.pkl')

    # Load Panen model
    model_panen = joblib.load(f'{MODEL_DIR}/model_panen_maggot.pkl')
    metadata_panen = joblib.load(f'{MODEL_DIR}/model_panen_metadata.pkl')
